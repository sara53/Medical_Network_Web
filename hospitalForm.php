<?php
	...
	if(isset($_POST['email']) && isset($_POST['password'])){
		...
		$result = mysqli_query($con, "select * from hospital where email = '$email' and password = '$pass'");
        ...
        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li><a href="patientForm.php">Login As A Patient</a></li>
             <li class="active"><a href="hospitalForm.php">Login To Hospital</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
    </nav>
      ...
      <div class="patient-form">
             <div class="form">
                 ...
                 <form action="<?php $_PHP_SELF?>" method="post">
                     ...
                     <span>Still New ?</span>
                     <a href="hospitalAccount.php">Create An Account</a>
                 </form>
            </div>
      </div>
<!--Start Hospital Form-->
