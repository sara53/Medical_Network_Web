<?php
	...
	if(isset($_POST['email']) && isset($_POST['password'])){
		...
		$result = mysqli_query($con, "select * from patient where email = '$email' and password = '$pass'");
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="patientForm.php">Login As A Patient</a></li>
      ...
      <div class="patient-form">
             <div class="form">
                 ...
                 <form action="<?php $_PHP_SELF?>" method="post">
                     ...
                     <span>Still New ?</span>
                     <a href="patientAccount.php">Create An Account</a>
                 </form>
             </div>
      </div>
<!--Start Patient Form-->
